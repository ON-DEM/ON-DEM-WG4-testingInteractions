#!/usr/bin/env python3
"""
Publication-quality figure generation script for DEM vs analytical comparison.

Usage:
    python3 make_figure_pub.py YADE 5
    python3 make_figure_pub.py SOFTWARE_LABEL TEST_ID
"""
...
def write_latex_table(metrics, test_id, software_label, output_dir):
    ...
    quantity_latex = {
        ...
        'Angular velocity': r'Angular velocity $\vec{\omega}$',
        'Force': r'Force $\vec{F}$',
...
def main():
    ...
    # Write LaTeX table
    write_latex_table(metrics, test_id, software_label, output_dir)
